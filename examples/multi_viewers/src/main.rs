...
use bevy::prelude::*;
use saddle_ai_saddle_ai_fov::{FovPlugin, GridFov, GridFovState, GridOpacityMap, merge_grid_visibility};
use support::{
...
fn main() {
    ...
    App::new()
        ...
        .add_systems(Update, animate_viewers.before(saddle_ai_fov::FovSystems::MarkDirty))
